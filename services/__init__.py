...
def uygulama_olustur(ayar_adi: str = None) -> Flask:
    ...
    # CORS ayarları (Wix Studio gibi dış platformlardan gelen isteklere izin verir)
    CORS(
        uygulama,
    ...
    # Rotaları (Blueprints) ana sisteme monte ediyoruz
    ...
    def saglik_kontrolu():
        """Sunucunun çalışıp çalışmadığını bildiren uç nokta (Health Check)."""
